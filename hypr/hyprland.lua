...
-- You can change the binds in 'BINDS' section
...
-- Automation for the animated wallpaper is currently not implemented. Please uncomment the following line to enable it

-- hl.exec_cmd("mpvpaper -vs -o "no-audio loop" ALL Images/Wallpapers/1.mp4")
